FROM centos:7
ARG XMRIG_VERSION=v6.15.1
RUN yum install -y epel-release centos-release-scl ca-certificates && yum install -y wget bzip2 git devtoolset-9-toolchain cmake3 automake libtool
